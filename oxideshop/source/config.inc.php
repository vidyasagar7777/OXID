 ...
 */
    ...
    $this->dbHost  = $_ENV['DB_HOST']; // database host name
    $this->dbPort  = 3306; // tcp port to which the database is bound
    $this->dbName = $_ENV['DB_NAME']; // database name
    $this->dbUser = $_ENV['DB_USER']; // database user name
    $this->dbPwd  = $_ENV['DB_PASS']; // database user password
    $this->sShopURL     = $_ENV['SHOP_URL']; // eShop base url, required
