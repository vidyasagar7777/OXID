...
unset($_smarty_tpl_vars);
 ?>
        ...
        <?php if ($this->_tpl_vars['oViewConf']->isTplBlocksDebugMode()): ?>
            ...
            <?php echo smarty_function_oxscript(array('add' => "$( 'body' ).oxBlockDebug();"), $this);?>
